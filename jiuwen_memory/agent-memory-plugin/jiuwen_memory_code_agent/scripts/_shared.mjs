...
// Platform detection
//
// Claude Code, Codex, and Copilot share this one script file, but inject
// different env vars when invoking hooks:
...
//   - Copilot sets COPILOT_PLUGIN_ROOT (hooks.copilot.json uses ${COPILOT_PLUGIN_ROOT})
//
// We use this to derive a per-platform default user_id so the agents
